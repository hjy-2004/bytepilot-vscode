...
export interface ToolExecutionContext {
  ...
  /** Platform filesystem (optional). Tools should use this if provided. */
  fs?: import('./platform').IFileSystem;
  /** Platform editor host (optional). Tools should use this if provided. */
  editor?: import('./platform').IEditorHost;
}
